...
@Disabled
                    ...
                    @TeleOp(name = "OpenCV Testing - Blue Blob")
                    public class OpenCVExampleBlueBlob extends LinearOpMode {
                        ...
                        class RedBlobDetectionPipeline extends OpenCvPipeline {
                            ...
                            private Mat preprocessFrame(Mat frame) {
                                ...
                                Scalar lowerblue = new Scalar(120, 100, 40);
                                Scalar upperblue = new Scalar(255, 255, 100);
