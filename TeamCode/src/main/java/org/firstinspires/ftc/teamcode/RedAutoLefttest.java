...
@Autonomous(name ="Red Left Tester",group = "Olympian")
public class RedAutoLefttest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.driveStraight(1, 35, 0);
        sleep(100);
        if ((int)cX<200) {
            robot.StrafeDist(1, 0, 90);

            sleep(100);
            robot.StrafeDist(1, 26.5, -90);
        }
        if ((int)cX>=200 && (int)cX<=400) {
            robot.driveStraight(1, 0, 0);
            robot.driveStraight(1, 26.5, -90);
        }
        if ((int)cX>400) {
            robot.StrafeDist(1, 0, -90);
            robot.StrafeDist(1, 26.5, -90);
        }
        robot.driveStraight(1, 108, 0);
        sleep(100);
        robot.resetHeading();
        sleep(100);
        robot.driveStraight(1, 18.5, 180);
        sleep(100);
        robot.driveStraight(1, 0, -90);
        sleep(100);
        robot.stop();
    }
}
