...
@TeleOp (name= "TitanTelePower" , group = "Titan")
public class TitanTelePower extends OpMode {
    ...
    public void driveLoop() {
        ...
        float rightX = -(gamepad1.left_stick_x);// assigning controller values to a variable
        float leftX = -(gamepad1.right_stick_x);
